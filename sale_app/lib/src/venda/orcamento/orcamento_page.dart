...
class OrcamentoPage extends StatefulWidget {
  int index = 0;
  OrcamentoPage({this.index});

  @override
  _OrcamentoPageState createState() => _OrcamentoPageState(index: index);
}

class _OrcamentoPageState extends State<OrcamentoPage> {
  int index;
  _OrcamentoPageState({this.index});
  ...
  DateFormat dataMovimentoFormat;
  DateFormat horaMovimentoFormat;
  ...
  void initState() { 
    ...
    dataMovimentoFormat = DateFormat.yMd('pt_BR');
    horaMovimentoFormat = DateFormat.jm('pt_BR');
  }
  ...
  shareFunction({index}) async {
    ...
    screenshotController.capture(
      ...
      .then((File image) async {
        ...
        await Share.files(
          'Compartilhar orçamento Fluggy',
          {
            'orcamentoFluggy$_dateTime.png': byteImg.buffer.asUint8List(),
          },
          '*/*',
          text: '');
                          ...
                          return Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text("${dataMovimentoFormat.format(vendaBloc.movimento.dataMovimento != null ? vendaBloc.movimento.dataMovimento : DateTime.now())}", style: TextStyle(
                                    color: Colors.black,
                                    fontSize: Theme.of(context).textTheme.body2.fontSize,
                                    fontStyle: Theme.of(context).textTheme.body2.fontStyle
                                    ), 
                                  ),
                                  Text(vendaBloc.movimento.idApp == null 
                                    ? "Novo orçamento" 
                                    : "Orçamento #${vendaBloc.movimento.idApp}",
                                    style: TextStyle(
                                      color: Colors.black,
                                  ...
                                  Text("${horaMovimentoFormat.format(vendaBloc.movimento.dataMovimento != null ? vendaBloc.movimento.dataMovimento : DateTime.now())}",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: Theme.of(context).textTheme.body2.fontSize,
                                      fontStyle: Theme.of(context).textTheme.body2.fontStyle
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text("Cliente: ${vendaBloc.nomeCliente != "" ? vendaBloc.nomeCliente : "Não informado"}\nVendedor: ${vendaBloc.nomeVendedor != "" ? vendaBloc.nomeVendedor : "Não informado"}",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: Theme.of(context).textTheme.body2.fontSize,
                                      fontStyle: Theme.of(context).textTheme.body2.fontStyle
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if ((produtoVariante != null) && (produtoVariante.variante.nome != "")) {
                                    a = a != ""
