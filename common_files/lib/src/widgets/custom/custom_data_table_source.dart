...
///
/// CustomDataTableSource objects are expected to be long-lived, not recreated with
/// each build.
abstract class CustomDataTableSource extends ChangeNotifier {
  /// Called to obtain the data about a particular row.
  ///
  /// The [new CustomDataRow.byIndex] constructor provides a convenient way to construct
  /// [CustomDataRow] objects for this callback's purposes without having to worry about
