...
class TextTheme extends Diagnosticable {
  ...
  final TextStyle display11;
  final TextStyle display10;
  final TextStyle display9;
  final TextStyle display8;
  final TextStyle display7;
  final TextStyle display6;
  ...
  TextTheme copyWith({
    ...
    return TextTheme(
      display11: display11 ?? this.display11,
      display10: display10 ?? this.display10,
      display9: display9 ?? this.display9,
      display8: display8 ?? this.display8,
      display7: display7 ?? this.display7,
      display6: display6 ?? this.display6,
  ...
  TextTheme merge(TextTheme other) {
    if (other == null)
      return this;
    return copyWith(
      display11: display11?.merge(other.display11) ?? other.display11,
      display10: display10?.merge(other.display10) ?? other.display10,
      display9: display9?.merge(other.display9) ?? other.display9,
      display8: display8?.merge(other.display8) ?? other.display8,
      display7: display7?.merge(other.display7) ?? other.display7,
      display6: display6?.merge(other.display6) ?? other.display6,
      display5: display5?.merge(other.display5) ?? other.display5,
  ...
  static TextTheme lerp(TextTheme a, TextTheme b, double t) {
    assert(t != null);
    return TextTheme(
      display11: TextStyle.lerp(a?.display5, b?.display11, t),
      display10: TextStyle.lerp(a?.display5, b?.display10, t),
      display9: TextStyle.lerp(a?.display5, b?.display9, t),
      display8: TextStyle.lerp(a?.display5, b?.display8, t),
      display7: TextStyle.lerp(a?.display5, b?.display7, t),
      display6: TextStyle.lerp(a?.display5, b?.display6, t),
      display5: TextStyle.lerp(a?.display5, b?.display5, t),
  ...
  bool operator ==(dynamic other) {
    ...
    return display11 == typedOther.display11
        && display10 == typedOther.display10
        && display9 == typedOther.display9
        && display8 == typedOther.display8
        && display7 == typedOther.display7
        && display6 == typedOther.display6
        && display5 == typedOther.display5
        && display4 == typedOther.display4
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>('display15', display15, defaultValue: defaultTheme.display15));
    properties.add(DiagnosticsProperty<TextStyle>('display14', display14, defaultValue: defaultTheme.display14));
    properties.add(DiagnosticsProperty<TextStyle>('display13', display13, defaultValue: defaultTheme.display13));
    properties.add(DiagnosticsProperty<TextStyle>('display12', display12, defaultValue: defaultTheme.display12));
    properties.add(DiagnosticsProperty<TextStyle>('display11', display11, defaultValue: defaultTheme.display11));
    properties.add(DiagnosticsProperty<TextStyle>('display10', display10, defaultValue: defaultTheme.display10));
    properties.add(DiagnosticsProperty<TextStyle>('display9', display9, defaultValue: defaultTheme.display9));
    properties.add(DiagnosticsProperty<TextStyle>('display8', display8, defaultValue: defaultTheme.display8));
    properties.add(DiagnosticsProperty<TextStyle>('display7', display7, defaultValue: defaultTheme.display7));
    properties.add(DiagnosticsProperty<TextStyle>('display6', display6, defaultValue: defaultTheme.display6));
    properties.add(DiagnosticsProperty<TextStyle>('display5', display5, defaultValue: defaultTheme.display5));
