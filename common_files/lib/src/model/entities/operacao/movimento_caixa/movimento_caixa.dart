...
class MovimentoCaixa implements IEntity {
  ...
  List<MovimentoCaixaParcela> _movimentoCaixaParcela;
  ...
  MovimentoCaixa(
      ...
      double vendaTotalValorBruto = 0,
      double vendaTotalValorDesconto = 0,
      double vendaTotalValorAcrescimo = 0,
      double vendaTotalValorLiquido = 0,
      double vendaTotalValorCancelado = 0,
      double vendaTotalValorDescontoItem = 0,
      double vendaTotalQuantidade = 0,
      double vendaTotalQuantidadeCancelada = 0,
      int vendaTotalItem = 0,
      int vendaTotalBoletoFechado = 0,
      int vendaTotalBoletoPedido = 0,
      int vendaTotalBoletoCancelado = 0,
      double devolucaoTotalValorBruto = 0,
      double devolucaoTotalValorDesconto = 0,
      double devolucaoTotalValorAcrescimo = 0,
      double devolucaoTotalValorLiquido = 0,
      double devolucaoTotalValorCancelado = 0,
      double devolucaoTotalQuantidade = 0,
      double devolucaoTotalQuantidadeCancelada = 0,
      int devolucaoTotalItem = 0,
      int devolucaoTotalBoletoFechado = 0,
      int devolucaoTotalBoletoCancelado = 0,
      double saidaTotalValorBruto = 0,
      double saidaTotalValorDesconto = 0,
      double saidaTotalValorAcrescimo = 0,
      double saidaTotalValorLiquido = 0,
      double saidaTotalValorCancelado = 0,
      double saidaTotalQuantidade = 0,
      double saidaTotalQuantidadeCancelada = 0,
      int saidaTotalItem = 0,
      int saidaTotalBoletoFechado = 0,
      int saidaTotalBoletoCancelado = 0,
      double entradaTotalValorBruto = 0,
      double entradaTotalValorDesconto = 0,
      double entradaTotalValorAcrescimo = 0,
      double entradaTotalValorLiquido = 0,
      double entradaTotalValorCancelado = 0,
      double entradaTotalQuantidade = 0,
      double entradaTotalQuantidadeCancelada = 0,
      int entradaTotalItem = 0,
      int entradaTotalBoletoFechado = 0,
      int entradaTotalBoletoCancelado = 0,
      DateTime dataAtualizacao,
      List<MovimentoCaixaParcela> movimentoCaixaParcela}) {
    this._idApp = idApp;
    this._id = id;
    ...
    this._movimentoCaixaParcela = movimentoCaixaParcela == null ? [] : movimentoCaixaParcela;
  }
  ...
  List<MovimentoCaixaParcela> get movimentoCaixaParcela => _movimentoCaixaParcela;
  set movimentoCaixaParcela(List<MovimentoCaixaParcela> movimentoCaixaParcela) =>
      _movimentoCaixaParcela = movimentoCaixaParcela;
  ...
  String toString() {
    return '''
      ...
      dataAbertura: ${_dataAbertura.toString()},  
      dataFechamento: ${_dataFechamento.toString()},  
      valorAbertura: ${_valorAbertura.toString()},  
      vendaTotalValorBruto: ${_vendaTotalValorBruto.toString()},  
      vendaTotalValorDesconto: ${_vendaTotalValorDesconto.toString()},  
      vendaTotalValorAcrescimo: ${_vendaTotalValorAcrescimo.toString()},  
      vendaTotalValorLiquido: ${_vendaTotalValorLiquido.toString()},  
      vendaTotalValorCancelado: ${_vendaTotalValorCancelado.toString()},  
      vendaTotalValorDescontoItem: ${_vendaTotalValorDescontoItem.toString()},  
      vendaTotalQuantidade: ${_vendaTotalQuantidade.toString()},  
      vendaTotalQuantidadeCancelada: ${_vendaTotalQuantidadeCancelada.toString()},  
      vendaTotalItem: ${_vendaTotalItem.toString()},  
      vendaTotalBoletoFechado: ${_vendaTotalBoletoFechado.toString()},  
      vendaTotalBoletoPedido: ${_vendaTotalBoletoPedido.toString()},  
      vendaTotalBoletoCancelado: ${_vendaTotalBoletoCancelado.toString()},  
      devolucaoTotalValorBruto: ${_devolucaoTotalValorBruto.toString()},  
      devolucaoTotalValorDesconto: ${_devolucaoTotalValorDesconto.toString()},  
      devolucaoTotalValorAcrescimo: ${_devolucaoTotalValorAcrescimo.toString()},  
      devolucaoTotalValorLiquido: ${_devolucaoTotalValorLiquido.toString()},  
      devolucaoTotalValorCancelado: ${_devolucaoTotalValorCancelado.toString()},  
      devolucaoTotalQuantidade: ${_devolucaoTotalQuantidade.toString()},  
      devolucaoTotalQuantidadeCancelada: ${_devolucaoTotalQuantidadeCancelada.toString()},  
      devolucaoTotalItem: ${_devolucaoTotalItem.toString()},  
      devolucaoTotalBoletoFechado: ${_devolucaoTotalBoletoFechado.toString()},  
      devolucaoTotalBoletoCancelado: ${_devolucaoTotalBoletoCancelado.toString()},  
      saidaTotalValorBruto: ${_saidaTotalValorBruto.toString()},  
      saidaTotalValorDesconto: ${_saidaTotalValorDesconto.toString()},  
      saidaTotalValorAcrescimo: ${_saidaTotalValorAcrescimo.toString()},  
      saidaTotalValorLiquido: ${_saidaTotalValorLiquido.toString()},  
      saidaTotalValorCancelado: ${_saidaTotalValorCancelado.toString()},  
      saidaTotalQuantidade: ${_saidaTotalQuantidade.toString()},  
      saidaTotalQuantidadeCancelada: ${_saidaTotalQuantidadeCancelada.toString()},  
      saidaTotalItem: ${_saidaTotalItem.toString()},  
      saidaTotalBoletoFechado: ${_saidaTotalBoletoFechado.toString()},  
      saidaTotalBoletoCancelado: ${_saidaTotalBoletoCancelado.toString()},  
      entradaTotalValorBruto: ${_entradaTotalValorBruto.toString()},  
      entradaTotalValorDesconto: ${_entradaTotalValorDesconto.toString()},  
      entradaTotalValorAcrescimo: ${_entradaTotalValorAcrescimo.toString()},  
      entradaTotalValorLiquido: ${_entradaTotalValorLiquido.toString()},  
      entradaTotalValorCancelado: ${_entradaTotalValorCancelado.toString()},  
      entradaTotalQuantidade: ${_entradaTotalQuantidade.toString()},  
      entradaTotalQuantidadeCancelada: ${_entradaTotalQuantidadeCancelada.toString()},  
      entradaTotalItem: ${_entradaTotalItem.toString()},  
      entradaTotalBoletoFechado: ${_entradaTotalBoletoFechado.toString()},  
      entradaTotalBoletoCancelado: ${_entradaTotalBoletoCancelado.toString()},  
  ...
  MovimentoCaixa.fromJson(Map<String, dynamic> json) {
    ...
    if (json['movimento_caixa_parcela'] != null) {
      _movimentoCaixaParcela = new List<MovimentoCaixaParcela>();
      json['movimento_caixa_parcela'].forEach((v) {
        _movimentoCaixaParcela.add(new MovimentoCaixaParcela.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._movimentoCaixaParcela != null) {
      data['movimento_item'] =
          this._movimentoCaixaParcela.map((v) => v.toJson()).toList();
    }
