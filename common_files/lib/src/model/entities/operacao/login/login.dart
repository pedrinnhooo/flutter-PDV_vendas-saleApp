...
import 'package:common_files/src/model/entities/cadastro/pessoa/pessoa_grupo.dart';
...
class Login {
  ...
  Login.fromJson(Map<String, dynamic> json) {
    ...
    _statusLogin = setStatusLoginIndex(json['status_login']);
