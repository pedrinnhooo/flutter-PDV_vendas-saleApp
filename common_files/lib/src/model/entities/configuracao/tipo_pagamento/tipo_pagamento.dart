...
class TipoPagamento implements IEntity {
  ...
  int get ehQrcode => _ehQrcode;
  set ehQrcode(int ehQrcode) => _ehQrcode = ehQrcode;
  ...
  String toString() {
    return '''
      ...
      nome: $_nome, 
      icone: $_icone, 
      ehDinheiro: ${_ehDinheiro.toString()},  
      ehFiado: ${_ehFiado.toString()},  
      ehQrCode: ${_ehQrcode.toString()},  
