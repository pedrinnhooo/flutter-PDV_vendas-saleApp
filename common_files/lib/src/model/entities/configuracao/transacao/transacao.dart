...
class Transacao implements IEntity {
  ...
  String toString() {
    return '''
      ...
      nome: $_nome, 
      tipoEstoque: ${_tipoEstoque.toString()},  
      temPagamento: ${_temPagamento.toString()},  
      temVendedor: ${_temVendedor.toString()},  
      temCliente: ${_temCliente.toString()},  
      temCliente: ${_temCliente.toString()},  
      descontoPercentual: ${_descontoPercentual.toString()}, 
