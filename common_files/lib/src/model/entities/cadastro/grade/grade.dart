...
class Grade implements IEntity {
  ...
  Grade.fromJson(Map<String, dynamic> json) {
    ...
    _dataCadastro = json['dataCadastro'] != null ? DateTime.parse(json['dataCadastro']) : null;
    _dataAtualizacao = json['dataAtualizacao'] != null ? DateTime.parse(json['dataAtualizacao']) : null;
  }
