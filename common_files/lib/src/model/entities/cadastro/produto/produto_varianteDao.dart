...
class ProdutoVarianteDAO implements IEntityDAO {
  ...
  ProdutoVarianteDAO(this._hasuraBloc, this._appGlobalBloc, {this.produtoVariante, this.produtoVarianteList}) {
    dao = Dao();
  ...
  Future<List> getAll({bool preLoad = false}) async {
    ...
    if (preLoad) {
      for (var produtoVariante in produtoVarianteList) {
        ...
        VarianteDAO varianteDAO = VarianteDAO(_hasuraBloc, _appGlobalBloc, variante: _vari);
