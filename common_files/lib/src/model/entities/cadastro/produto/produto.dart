...
class Produto extends IEntity {
  ...
  List<PrecoTabelaItem> _precoTabelaItem;
  List<ProdutoCodigoBarras> _produtoCodigoBarras;
  ...
  Produto(
      ...
      List<PrecoTabelaItem> precoTabelaItem,
      List<ProdutoCodigoBarras> produtoCodigoBarras}) {
    this._id = id;
    ...
    this._precoTabelaItem = precoTabelaItem == null ? [] : precoTabelaItem;
    this._produtoCodigoBarras = produtoCodigoBarras == null ? [] : produtoCodigoBarras;
  }
  ...
  List<PrecoTabelaItem> get precoTabelaItem => _precoTabelaItem;
  set precoTabelaItem(List<PrecoTabelaItem> precoTabelaItem) => _precoTabelaItem = precoTabelaItem;
  List<ProdutoCodigoBarras> get produtoCodigoBarras => _produtoCodigoBarras;
  set produtoCodigoBarras(List<ProdutoCodigoBarras> produtoCodigoBarras) => _produtoCodigoBarras = produtoCodigoBarras;

  String toString() {
    return '''
      id: ${_id.toString()},    
      idPessoaGrupo: ${_idPessoaGrupo.toString()},  
      idAparente: $_idAparente, 
      idCategoria: ${_idCategoria.toString()},  
      idGrade: ${_idGrade.toString()},  
      nome: $_nome, 
      iconeCor: $_iconeCor, 
      ...
      produtoImagem: ${_produtoImagem.toString()},
      precoTabelaItem: ${_precoTabelaItem.toString()},
      produtoVariante: ${_produtoVariante.toString()},
      produtoCodigoBarras: ${_produtoCodigoBarras.toString()},
    ''';  
  }
  ...
  Produto.fromJson(Map<String, dynamic> json) {
    ...
    print("Produto.fromJson antes produto imagem");
    ...
    print("Produto.fromJson antes produto variante");
    ...
    print("Produto.fromJson antes preco_tabela_items");
    if (json['preco_tabela_items'] != null) {
      _precoTabelaItem = new List<PrecoTabelaItem>();
      json['preco_tabela_items'].forEach((v) {
        _precoTabelaItem.add(new PrecoTabelaItem.fromJson(v));
      });
    }
    print("Produto.fromJson antes produto_codigo_barras");
    if (json['produto_codigo_barras'] != null) {
      _produtoCodigoBarras = new List<ProdutoCodigoBarras>();
      json['produto_codigo_barras'].forEach((v) {
        _produtoCodigoBarras.add(new ProdutoCodigoBarras.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._precoTabelaItem != null) {
      data['preco_tabela_item'] =
          this._precoTabelaItem.map((v) => v.toJson()).toList();
    }
    if (this._produtoCodigoBarras != null) {
      data['produto_codigo_barras'] =
          this._produtoCodigoBarras.map((v) => v.toJson()).toList();
    }
    return data;
  }
