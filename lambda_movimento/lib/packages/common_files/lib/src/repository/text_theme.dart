...
class TextTheme extends Diagnosticable {
  ...
  TextTheme copyWith({
    ...
    return TextTheme(
      display11: display5 ?? this.display11,
      display10: display5 ?? this.display10,
      display9: display5 ?? this.display9,
      display8: display5 ?? this.display8,
      display7: display5 ?? this.display7,
      display6: display5 ?? this.display6,
