...
class LoginGoogle {
  ...
  Future getUsuario() async {
    print("LoginGoogle -> getUsuario INICIO");
    ...
    String sql = """
      ...
      from pessoa p where p.ehusuario = 1 and id_google = @pIdGoogle
    """; 
    print("sql: "+sql);
    print("idGoogle: "+_login.usuario.idGoogle);
    var result = await postgresConnection.query(sql, substitutionValues: {
      "pIdGoogle" : _login.usuario.idGoogle
    });
    print(result);
    if (result.length > 0) {
      try{
