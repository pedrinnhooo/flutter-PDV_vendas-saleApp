  ...
  Future<Login> vinculaFacebook() async {
    ...
    if ((_login.usuario.id != null) && (_login.usuario.id > 0 ) && 
      ...
      try {
        ...
        _login.usuario.idFacebook = data["data"]["update_pessoa"]["returning"][0]["id_facebook"];
        return _login;
      } catch (error) {
        print("Erro <vinculaFacebook>: "+error);
        _login.token = null;
        return _login;
      }  
//      print("vinculaFacebook - FIM");
    }
  }
